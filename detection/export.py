...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/citrus_sec_transformer/ori_4855.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'output/ori_sec_transformer/v5s/ours_trans/adam_lowlr/train/exp/weights/last.pt', help='model.pt path(s)')
