...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/citrus.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/ourloss.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--project', default= ROOT / 'runs/train/citrus_evel/oriloss/pw012/s001a', help='save to project/name')
