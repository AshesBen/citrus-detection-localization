...
def run(data,
    ...
    # s = ('%20s' + '%20s' * 6) % ('Class', 'Images', 'Labels', 'P', 'R', 'mAP@.5', 'mAP@.5:.95')
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path(data.get('path','/home/zk203/zxd/yolov5-master/coco')) / 'annotations/instances_val2017.json')  # annotations json
